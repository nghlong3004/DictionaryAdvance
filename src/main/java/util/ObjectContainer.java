...
public class ObjectContainer {
	...
	private final static AccountServiceInterface USER_SERVICE_INTERFACE = AccountService.getInstance(PROPERTY_HELPER);
	private final static UserController USER_CONTROLLER = new UserController(USER_SERVICE_INTERFACE);
	
	private final static DictionaryServiceInterface DICTIONARY_SERVICE_INTERFACE = DictionaryService.getInstance(PROPERTY_HELPER);
