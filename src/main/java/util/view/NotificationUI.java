...
public class NotificationUI {
  ...
  public static void welcome() {
    Notification.getInstance().show(Notification.Type.INFO, Notification.Location.TOP_CENTER,
        "Welcome to Dictionary Advance by Nghlong3004!");
  }
  ...
  public static void succes(String message) {
    Notification.getInstance().show(Notification.Type.SUCCESS, Notification.Location.TOP_CENTER,
        message);
  }

  public static void warning(String message) {
    Notification.getInstance().show(Notification.Type.WARNING, Notification.Location.TOP_CENTER,
        message);
  }
