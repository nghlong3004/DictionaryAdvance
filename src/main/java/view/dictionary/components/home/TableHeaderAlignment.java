...
public class TableHeaderAlignment implements TableCellRenderer {
  ...
  public TableHeaderAlignment(JTable table) {
    ...
    table.setDefaultRenderer(Object.class, new TableCellRenderer() {
      ...
      public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln,
        ...
        JLabel label = (JLabel) oldCellRenderer.getTableCellRendererComponent(jtable, o, bln, bln1,
            row, column);
  ...
  public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1,
      int row, int column) {
    JLabel label =
        (JLabel) oldHeaderRenderer.getTableCellRendererComponent(jtable, o, bln, bln1, row, column);
    label.setHorizontalAlignment(getAlignment(1));
    return label;
  }
