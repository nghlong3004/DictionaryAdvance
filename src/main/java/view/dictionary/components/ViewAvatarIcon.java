...
public class ViewAvatarIcon extends Theme {

  /**
  * 
  */
  private static final long serialVersionUID = -9172554064175452219L;
  private Menu menu;

  public ViewAvatarIcon(Menu menu) {
    this.menu = menu;
    init();
  }
  ...
  private Component createBorderOption() {
    ...
    AvatarIcon.BorderColor[] colors = {new AvatarIcon.BorderColor(Color.decode("#3B82F6")),
  ...
  private Component createAvatar() {
    ...
    panel.setBorder(new TitledBorder("Avatar"));
  ...
  private void setAvatar() {
    ...
    labelAvatar.setIcon(buildAvatar(width, height, value, borderWidth, innerBorderWidth, squircle));
    menu.setAvatarIcon(buildAvatar(45, 45, value, 2, innerBorderWidth, squircle));
  }
  private AvatarIcon buildAvatar(int width, int height, float value, int borderWidth, int innerBorderWidth, boolean squircle) {
    AvatarIcon avatarIcon =
        new AvatarIcon(getClass().getResource("/image/profile.jpg"), width, height, value);
