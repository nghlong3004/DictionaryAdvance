...
public class Menu extends JPanel {
   ...
   * 
   */
  private static final long serialVersionUID = -5104399221892412257L;
  ...
  public Menu(String fullname, String username) {
    init();
    setHeader(fullname, username);
  }

  public void setHeader(String fullname, String username) {
    headerName =
        "<html>" + "<p style='font-size: 10px;'>Xin chào</p>" + "<p style='font-size: 15px; "
            + "color:" + "#64748b" + ";'>" + fullname + "</p>" + "<p style='font-size: 10px; "
            + "color:" + "#64748b" + ";'>" + username + "</p>" + "</html>";
    header.setText(headerName);
