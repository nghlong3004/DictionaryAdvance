...
public class MenuItem extends JPanel {
   ...
   * 
   */
  private static final long serialVersionUID = -8102652553013614455L;
  ...
  private Icon getIcon() {
    ...
    FlatSVGIcon icon = new FlatSVGIcon("image\\" + menuImage[menuIndex]);
  ...
  private JButton createButtonItem(String text) {
    ...
    button.putClientProperty(FlatClientProperties.STYLE, "" + "background:$Menu.background;"
        + "foreground:$Menu.foreground;" + "selectedBackground:$Menu.button.selectedBackground;"
