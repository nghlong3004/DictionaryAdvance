...
public class LightDarkMode extends JPanel {
   ...
   * 
   */
  private static final long serialVersionUID = -3336734256356973996L;
  ...
  private void init() {
    ...
    buttonLight = new JButton("Light", new FlatSVGIcon("themes\\icon\\light.svg", 0.6f));
    buttonDark = new JButton("Dark", new FlatSVGIcon("themes\\icon\\dark.svg", 0.6f));
    buttonLighDark = new JButton();
    buttonLighDark.putClientProperty(FlatClientProperties.STYLE,
        "" + "arc:999;" + "background:$Menu.lightdark.button.background;"
            + "foreground:$Menu.foreground;" + "focusWidth:0;" + "borderWidth:0;"
            + "innerFocusWidth:0");
  ...
  private void checkStyle() {
    ...
    if (isDark) {
      buttonLighDark.setIcon(new FlatSVGIcon("themes\\icon\\dark.svg"));
    } else {
      buttonLighDark.setIcon(new FlatSVGIcon("themes\\icon\\light.svg"));
    }
  }
  ...
  private void addStyle(JButton button, boolean style) {
    if (style) {
      ...
      button.putClientProperty(FlatClientProperties.STYLE,
          "" + "arc:999;" + "background:$Menu.lightdark.button.background;"
              + "foreground:$Menu.foreground;" + "focusWidth:0;" + "borderWidth:0;"
              + "innerFocusWidth:0;" + "background:null");
    }
  }
