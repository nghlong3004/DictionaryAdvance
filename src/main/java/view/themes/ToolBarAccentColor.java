...
public class ToolBarAccentColor extends JPanel {
   ...
   * 
   */
  private static final long serialVersionUID = 1532748580863037896L;
  ...
  private void init() {
    ...
    selectedButton.addActionListener((ActionEvent e) -> {
      int y = (selectedButton.getPreferredSize().height
    ...
    for (int i = 0; i < accentColorNames.length; i++) {
      ...
      tbutton
          .setSelected(UIManager.getColor("Component.accentColor").equals(UIManager.getColor(key)));
  ...
  private void colorAccentChanged(String colorKey) throws IllegalArgumentException,
